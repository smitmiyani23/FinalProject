...
Based on the logLoss metric, model 1 is the best model from Logistic regression type models. \
...
Based on logloss, the best fit model is `logreg_fit1.`
