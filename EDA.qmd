...
5.  **Correlation Analysis-** Examine relationships between the prediction variables with each other via a correlation matrix to check for multicolinearity using `cor()` from base R.\
